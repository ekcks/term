...
import com.bips.reserve.domain.entity.Admin;
        ...
        import com.bips.reserve.dto.hospital.HospitalSimpleInfoDto;
        import com.bips.reserve.repository.custom.HospitalCustomRepository;
...
public interface HospitalRepository extends JpaRepository<Hospital, Long>, HospitalCustomRepository {
     ...
     */
    @Query("select new com.bips.reserve.dto.hospital.HospitalSimpleInfoDto(h.hospitalName,h.address) " +
            "from Hospital h " +
